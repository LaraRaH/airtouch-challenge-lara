"""
Django settings for airtouch_challenge project.
...
SECRET_KEY = "django-insecure-s#n&v^%lsf(+-m_#o$_mjgtri#da*!83i5q9ne=!6$2r+ge+^p"
...
ROOT_URLCONF = "airtouch_challenge.urls"
...
WSGI_APPLICATION = "airtouch_challenge.wsgi.application"
